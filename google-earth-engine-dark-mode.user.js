...
// @description	  GEE code editor dark mode
// @author        João Siqueira
// @homepage      https://userstyles.org/styles/187669
// @run-at        document-start
// @version       0.20200809035421
// ==/UserScript==
(function() {var css = [
	"@media all and (-webkit-min-device-pixel-ratio:0) and (min-resolution: .001dpcm) {",
	"html {",
	"    /*--ee-button-action-color: #fff;",
	"    --ee-button-cancel-color: var(--google-grey-800);",
	"    --ee-button-disabled-bg-color: var(--google-grey-100);",
	"    --ee-button-disabled-color: var(--google-grey-700);",
	"    --ee-button-font-size: 14px;",
	"    --ee-button-hover-bg-color: var(--google-grey-100);",
	"    --ee-button-menu-color: #fff;",
	"    --ee-legacy-blue: #2196f3;",
	"    --ee-legacy-paper-dialog-title: 500 20px Roboto,Helvetica,Arial,sans-serif;*/",
	...
	"}",
	"",
	".env-list>.header, .env-list>.body {",
	"    background: #21242f;",
	"    color: #ddd7d7;",
	"    border: 1px solid #21242f;",
	"}",
	"",
	".ace_ee_instance, .ace_ee_static {",
	...
	"}",
	"",
	".ace_storage, .ace_keyword, .ace_language:not(.ace_variable) {",
	...
	"}",
	"",
	".tree-manager .tree-item, .tree-manager .create-link {",
	"        font-weight: normal;",
	"        color: #dad759ab;",
	"        font-style: normal;",
	"        line-height: 25px;",
	...
	"}",
	"",
	".tree-manager .tree-file:before, .tree-drag-clone.tree-file:before, .tree-drag-clone.header:before {",
	"    content: \'\';",
	"    width: 14px;",
	"    height: 14px;",
	"    position: absolute;",
	...
	"}",
	"",
	".tree-manager .tree-file:before, .tree-drag-clone.tree-file:before {",
	...
	"}",
	"",
	"paper-button-menu, paper-button-menu-legacy {",
	"    color: #fff;",
	...
	"}",
	"",
	".tree-manager .tree-file:hover, .tree-manager .tree-file.tree-item-selected {",
	"    background: #00000073;",
	"    cursor: pointer;",
	"}",
	"",
	...
	"}",
	"    ",
	".editor-panel>.header .goog-flat-menu-button.goog-flat-menu-button:hover:after, .editor-panel>.header .goog-flat-menu-button.goog-flat-menu-button-open:after, .editor-panel>.header .goog-flat-menu-button.goog-flat-menu-button-active:after {",
	"    opacity: 1.0",
	"}",
	"",
	...
	"}",
	"",
	".docs-list .docs-method-header:hover, .docs-list-popup .docs-method-header {",
	"    background: #00000073;",
	"}",
	"",
	".zippy>.header:hover {",
	...
	"}",
	"",
	".task.running-on-client .indicator, .task.submitted-to-backend .indicator, .task.running-on-backend .indicator {",
	...
	"}",
	"",
	".tree-manager.loading .zippy>.header:before,.tree-manager .tree-folder.loading .zippy>.header:before,.tree-manager .zippy.loading>.header:before {",
	"    content: url(https://user-images.githubusercontent.com/14841756/81141107-f9834f80-8f41-11ea-9b57-dba954453679.gif);",
	"    float: left;",
	"    opacity: 1;",
	"    top: 1px;",
	...
	"}",
	"",
	".ui-panel .stretch-vertical, .ui-panel .stretch-horizontal {",
	...
	"}",
	"",
	".ui-button .jfk-button, .ui-select .jfk-select, .ui-textbox .jfk-textinput {",
	...
	"}",
	"",
	".map-control-list:hover .title,.map-control-list.expanded .title {",
	"    background: #342f2f;",
	"    color: #ffffff;",
	"    font-weight: bold",
	"}",
	"",
	".map-control-list.layer-list:hover .title, .map-control-list.layer-list.expanded .title {",
	"    background: #342f2f;",
	"    color: #ffffff;",
	"    font-weight: bold",
	"}",
	...
	"}",
	"",
	".map-control-list .opacity-slider .goog-slider-thumb, .ee-visualizer .goog-slider-thumb{",
	"    background: #342F2F;",
	"}",
	"",
	"#head {",
	...
	"}",
	".ee-search .search-results, .ee-search .featured-results {",
	"    background: #0a0a0a;",
